...
public class FCFS extends AppCompatActivity {
    ...
    public void click(View v)
    {
        ...
        if(n.matches("[0-9]+") && n.length()>0)
        {
            ...
            if(n1 > 10)
            {
                Toast.makeText(FCFS.this, "Number Of Process is greater than 10", Toast.LENGTH_SHORT).show();
            }
            else
            {
                ...
                if(test_a.matches("[0-9]+") && temp1.length==n1)
                {
                    if(test_b.matches("[0-9]+") && temp2.length==n1)
                    {
                        ...
                        PyObject pyobj = py.getModule("FCFS");
                    ...
                    {
                        Toast.makeText(FCFS.this, "invalid input", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
